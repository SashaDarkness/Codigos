...
public class DaoWasabiApp {
    public static void main(String[] args) throws IOException {
        DaoCliente cliente = new DaoCliente();
        DaoPedido pedido = new DaoPedido();
        DaoCardapio cardapio = new DaoEstoqueDisponivel();

        List<String> listaPratos = new ArrayList<>();
        List<DaoEstoqueDisponivel> estoqueDisponiveisPratos = new ArrayList<>();
        ...
        while (continuar) {
            ...
            if (menuValue.equals("PRATOS DE ENTRADA")) {
                estoqueDisponiveisPratos = DaoEstoqueDisponivel.getEstoquePratosEntrada(); // estoqueDisponiveisPratos=((EstoqueDisponivel)cardapio).getEstoquePratosEntrada();

                for (DaoEstoqueDisponivel e : estoqueDisponiveisPratos) {
                    listaPratos.add(e.getNomeCardapio());
                }

            } else if (menuValue.equals("PRATOS PROMOCIONAIS")) {
                estoqueDisponiveisPratos = DaoEstoqueDisponivel.getEstoquePratosPromocionais();
                ...
                estoqueDisponiveisPratos = DaoEstoqueDisponivel.getEstoquePratosTemakiEspecial();
                ...
                estoqueDisponiveisPratos = DaoEstoqueDisponivel.getEstoquePratosHollWassabi();
            ...
            for (DaoEstoqueDisponivel estoque : estoqueDisponiveisPratos) {
                if (estoque.getNomeCardapio().equals(adicionarPratos)) { //if (estoque.getNomeCardapio() == adicionarPratos) {
                    cardapio = estoque;
                }
            }
